        ...
        <div className="relative max-w-6xl mx-auto px-6 md:px-10 lg:px-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <Link href="/contact" className="ml-2">
              <button className="px-5 py-2.5 text-[10px] md:text-xs uppercase font-bold tracking-[0.25em] rounded-lg bg-gradient-to-r from-orange-500 via-pink-500 to-purple-600 text-black hover:opacity-95 hover:-translate-y-[1px] hover:shadow-[0_8px_24px_rgba(255,255,255,0.12)] transition-all duration-300">
                Start Project
              </button>
            </Link>
          </nav>
          ...
          >
            ...
            <nav className="flex flex-col items-center gap-8">
              ...
              <Link href="/contact" onClick={() => setIsMobileMenuOpen(false)}>
                <button className="mt-6 px-8 py-3 text-base font-bold uppercase tracking-[0.2em] rounded-lg bg-gradient-to-r from-orange-500 via-pink-500 to-purple-600 text-black hover:opacity-95 transition-all">
                  Start Project
                </button>
              </Link>
            </nav>
